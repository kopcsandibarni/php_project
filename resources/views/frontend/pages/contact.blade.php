...
@section('main-content')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Kapcsolat</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Írj nekünk üzenetet @auth @else<span style="font-size:12px;" class="text-danger">[Először be kell jelentkezned]</span>@endauth</h3>
								</div>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Hívj fel minket:</h4>
									<ul>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Az üzeneted sikeresen el lett küldve...</p>
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-warning">Elnézést!</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<p class="text-warning">Valami hiba lépett fel.</p>
			</div>
		  </div>
		</div>
	</div>
